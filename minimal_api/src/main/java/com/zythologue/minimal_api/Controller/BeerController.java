...
public class BeerController {
    ...
    @GetMapping("/beer/{id}")
    public ResponseEntity<List<BeerDTO>> getBeerById(@PathVariable
    int id) {
    ...
    @PostMapping("/beer")
    public void updateBeer(@RequestBody
    BeerDTO beer) {
        jdbcTemplate.update(
    ...
    @PutMapping("beer/{id}")
    public void updateBeer(@PathVariable
    int id, @RequestBody
    BeerDTO beer) {
        jdbcTemplate.update(
    ...
    public void deleteBeer(@PathVariable
    int id) {
